...
result_file_path = r'../MLPZDHcombined.csv'
...
plt.title('Multilayer Perceptron Under Zero-effort Attack')
plt.tight_layout()
...
plt.legend(bbox_to_anchor=(1.005, 1.005), ncol=1)
plt.legend(ncol=4,loc='upper center')
plt.title('Multilayer Perceptron Under Dictionary-effort Attack')
plt.tight_layout()
...
# plt.legend(bbox_to_anchor=(1.005, 1.005), ncol=1)
plt.legend(ncol=4,loc='upper center')
plt.title('Multilayer Perceptron Under High-effort Attack')
plt.tight_layout()

...
print(DictionaryEffort.groupby('classifier').mean().sort_values(by="far"))
...
print(DictionaryEffort.groupby('sensors').mean().sort_values(by="far"))
print(HighEffort.groupby('sensors').mean().sort_values(by="far"))

print("************Userwise and scenariowise stats***************")
print(ZeroEffort.groupby('user').mean().sort_values(by="hter"))
print(DictionaryEffort.groupby('user').mean().sort_values(by="far"))
print(HighEffort.groupby('user').mean().sort_values(by="far"))
# ########################################################################################################################
# sns.set()

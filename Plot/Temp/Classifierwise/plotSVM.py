...
result_file_path = r'../SVMZDHCombined.csv'
...
plt.title('Support Vector Machine Under Zero-effort Attack')
plt.tight_layout()
...
plt.legend(bbox_to_anchor=(1.005, 1.005), ncol=1)
plt.legend(ncol=4,loc='upper center')
plt.title('Support Vector Machine Under Dictionary-effort Attack')
plt.tight_layout()
...
# plt.legend(bbox_to_anchor=(1.005, 1.005), ncol=1)
plt.legend(ncol=4,loc='upper center')
plt.title('Support Vector Machine Under High-effort Attack')
plt.tight_layout()

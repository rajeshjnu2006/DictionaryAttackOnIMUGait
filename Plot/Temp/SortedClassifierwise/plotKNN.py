...
result_file_path = r'../kNNZDHcombined.csv'
...
for sensor_comb in sensor_dict:
    ...
    # ordered_user_list = ['User1', 'User2','User3', 'User4']
...
p1 = sns.barplot(x='sensors', y='error', hue= 'errortype', data=ZeroEffortMelted, order=sensor_name_list, edgecolor = 'w',errwidth=0.7)
